    ...
    class HighchartsOps extends PlotOps {
      constructor(elemID) {
        ...
        addPoint = (pen) => {
          ...
          return (x, y) => {
            ...
            pointY = (pen.getPenMode() === PenBundle.PenMode.Down) ? (maybeLastUpPoint !== null ? (series.addPoint(maybeLastUpPoint, false), maybeLastUpPoint = null) : void 0, y) : (maybeLastUpPoint = [x, y], null);
      ...
      seriesTypeOptions(type, interval) {
        ...
        return {
          ...
          pointRange: isColumn ? interval : null,
          animation: !isColumn,
          connectNulls: false
        };
      }
